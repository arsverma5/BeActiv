...
class ChallengeManager {
    ...
    private let predefinedChallenges: [Challenge] = [
        Challenge(title: "Walk 10,000+ Steps", description: "Walk 10,000+ steps every day for an entire week.", icon: "🚶", progress: 0.0),
        Challenge(title: "Beat 5 Friends", description: "Have a higher step count than 5 friends.", icon: "🏆", progress: 0.0),
        Challenge(title: "Walk 15,000+ Steps", description: "Walk 15,000+ steps every day for an entire week.", icon: "🏃‍♂️", progress: 0.0),
        Challenge(title: "Walk 20,000+ Steps", description: "Walk 20,000+ steps every day for three days.", icon: "🏃", progress: 0.0),
    ...
    func clearAndAddPredefinedChallenges(completion: @escaping (Error?) -> Void) {
